...
describe("dashboardPrimaryCreateAction", () => {
  ...
  it("behåller arbetsorderåtgärden inne i arbetsordermodulen men inte i admin- eller skapa-vyn", () => {
    expect(dashboardPrimaryCreateAction("/dashboard/arbetsorder/planering", "admin")).toEqual({
      ...
      label: "Fördela arbete",
    });
    expect(dashboardPrimaryCreateAction("/dashboard/arbetsorder/planering", "manager")?.label).toBe("Fördela arbete");
    expect(dashboardPrimaryCreateAction("/dashboard/arbetsorder/planering", "technician")).toBeNull();
  ...
  it("visar modulspecifika skapa-knappar på drift- och boendesidor", () => {
    ...
    expect(dashboardPrimaryCreateAction("/dashboard/uthyrning/overlamning", "owner")).toEqual({
      href: "/dashboard/uthyrning/overlamning#valj-avtal",
      label: "Välj avtal",
    });
    ...
    expect(dashboardPrimaryCreateAction("/dashboard/integrationer/fakturaexporter", "owner")).toEqual({
      href: "/dashboard/integrationer/fakturaexporter#exportfilter",
      label: "Filtrera export",
    });
