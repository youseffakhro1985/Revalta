...
type Item = { id: string; property_id: string; property_name: string; component: string; measure: string; planned_year: number; estimated_cost: number; priority: string; interval_years: number; status: string; work_order_id?: string | null; work_order_number?: string | null };
