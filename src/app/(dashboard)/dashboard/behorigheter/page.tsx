...
export default async function PermissionsPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in-soft">
      ...
      <Panel title="Behörighetsmatris" description="Standardbehörighet för respektive roll." bodyClassName="p-0">
      ...
      <Panel title="Användare och roller" description="Rolländringar görs från Team tills individuell fastighetsbehörighet är aktiverad." bodyClassName="p-0">
