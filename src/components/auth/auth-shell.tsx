...
export function AuthAlert({
  ...
  return (
    <div
      aria-live="polite"
      className={`mt-6 rounded-xl border p-4 text-sm leading-6 ${toneClass}`}
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#FAFAF8] px-4 py-8 text-ink-950 sm:px-6 lg:flex lg:items-center lg:py-12">
      ...
      <div className="relative mx-auto w-full max-w-[1080px]">
        <Link
          href="/"
          className="mb-8 inline-flex items-center gap-2 text-sm font-semibold text-petroleum-800 transition-colors hover:text-petroleum-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-petroleum-600/30 focus-visible:ring-offset-4"
        >
        ...
        <div className="grid overflow-hidden rounded-[28px] border border-sand-200 bg-white shadow-premium-lg lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <section aria-labelledby="auth-title" className="p-7 sm:p-10 lg:p-12">
            ...
            <h1
              id="auth-title"
              className="mt-4 font-display text-[34px] font-semibold leading-tight tracking-[-0.035em] text-ink-950 sm:text-[40px]"
            >
              {title}
            </h1>
