...
export async function runAuthNavigation(env = process.env, dependencies = {}) {
  return runVerifiedPreview(env, async ({ target, assertRelease, complete }) => {
    ...
    try {
      ...
      const unknownLeaseInspectionItemWorkOrdersPost = await page.evaluate(async () => {
        const response = await fetch("/api/leases/00000000-0000-4000-8000-000000000077/inspection-items/work-orders", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({ version: 1, itemIds: ["e2e-unknown-inspection-item"] }),
        });
        let json = null;
        try {
          json = await response.json();
      ...
      validateOwnerUnknownLeaseInspectionItemWorkOrdersPostNotFound(unknownLeaseInspectionItemWorkOrdersPost.status, unknownLeaseInspectionItemWorkOrdersPost.body);
      const unknownLeaseInspectionWorkOrdersReconcile = await page.evaluate(async () => {
        const response = await fetch("/api/leases/00000000-0000-4000-8000-000000000078/inspection-work-orders/reconcile", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
      ...
      validateOwnerUnknownLeaseInspectionWorkOrdersReconcileNotFound(unknownLeaseInspectionWorkOrdersReconcile.status, unknownLeaseInspectionWorkOrdersReconcile.body);
      const unknownLeaseInspectionWorkOrdersStatus = await page.evaluate(async () => {
        const response = await fetch("/api/leases/00000000-0000-4000-8000-000000000079/inspection-work-orders/status", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownLeaseInspectionWorkOrdersStatusNotFound(unknownLeaseInspectionWorkOrdersStatus.status, unknownLeaseInspectionWorkOrdersStatus.body);
      const unknownPropertyCard = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000080/card", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyCardNotFound(unknownPropertyCard.status, unknownPropertyCard.body);
      const unknownPropertyComponents = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000081/components", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyComponentsNotFound(unknownPropertyComponents.status, unknownPropertyComponents.body);
      const unknownPropertyMaintenancePlan = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000082/maintenance-plan", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyMaintenancePlanNotFound(unknownPropertyMaintenancePlan.status, unknownPropertyMaintenancePlan.body);
      const unknownDocumentDownload = await page.evaluate(async () => {
        const response = await fetch("/api/documents/00000000-0000-4000-8000-000000000083/download", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownDocumentDownloadNotFound(unknownDocumentDownload.status, unknownDocumentDownload.body);
      const unknownAttachment = await page.evaluate(async () => {
        const response = await fetch("/api/attachments/00000000-0000-4000-8000-000000000084", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownAttachmentNotFound(unknownAttachment.status, unknownAttachment.body);
      const unknownWorkOrderReportItem = await page.evaluate(async () => {
        const response = await fetch("/api/work-order-reports/00000000-0000-4000-8000-000000000085", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownWorkOrderReportItemNotFound(unknownWorkOrderReportItem.status, unknownWorkOrderReportItem.body);
      const unknownImdAttachNotice = await page.evaluate(async () => {
        const response = await fetch("/api/imd-readings/00000000-0000-4000-8000-000000000086/attach-notice", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({ createNotice: true }),
        });
        let json = null;
        try {
          json = await response.json();
      ...
      validateOwnerUnknownImdAttachNoticeNotFound(unknownImdAttachNotice.status, unknownImdAttachNotice.body);
      const unknownOperationalDocumentDownload = await page.evaluate(async () => {
        const response = await fetch("/api/operational-documents/00000000-0000-4000-8000-000000000087/download", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownOperationalDocumentDownloadNotFound(unknownOperationalDocumentDownload.status, unknownOperationalDocumentDownload.body);
      const unknownPublicTicket = await page.evaluate(async () => {
        const response = await fetch("/api/public/tickets/00000000-0000-4000-8000-000000000088?email=e2e-unknown-public-ticket@example.com", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPublicTicketNotFound(unknownPublicTicket.status, unknownPublicTicket.body);
      const unknownPublicTicketComment = await page.evaluate(async () => {
        const response = await fetch("/api/public/tickets/00000000-0000-4000-8000-000000000089/comments", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({
            email: "e2e-unknown-public-ticket-comment@example.com",
            body: "E2E unknown public ticket comment",
          }),
        });
        let json = null;
        try {
      ...
      validateOwnerUnknownPublicTicketCommentNotFound(unknownPublicTicketComment.status, unknownPublicTicketComment.body);
      const unknownPublicTicketAttachment = await page.evaluate(async () => {
        const form = new FormData();
        form.append("email", "e2e-unknown-public-ticket-attachment@example.com");
        form.append("file", new File(["E2E unknown public ticket attachment"], "e2e-unknown-public-ticket-attachment.txt", { type: "text/plain" }));
        const response = await fetch("/api/public/tickets/00000000-0000-4000-8000-000000000090/attachments", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPublicTicketAttachmentNotFound(unknownPublicTicketAttachment.status, unknownPublicTicketAttachment.body);
      const unknownPublicTicketFeedback = await page.evaluate(async () => {
        const response = await fetch("/api/public/tickets/00000000-0000-4000-8000-000000000091/feedback", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({
            email: "e2e-unknown-public-ticket-feedback@example.com",
            rating: 5,
          }),
        });
        let json = null;
      ...
      validateOwnerUnknownPublicTicketFeedbackNotFound(unknownPublicTicketFeedback.status, unknownPublicTicketFeedback.body);
      const unknownResidentPortalTicket = await page.evaluate(async () => {
        const response = await fetch("/api/resident-portal/tickets/00000000-0000-4000-8000-000000000092", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownResidentPortalTicketNotFound(unknownResidentPortalTicket.status, unknownResidentPortalTicket.body);
      const unknownResidentPortalTicketComment = await page.evaluate(async () => {
        const response = await fetch("/api/resident-portal/tickets/00000000-0000-4000-8000-000000000093/comments", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({ body: "E2E unknown resident portal ticket comment" }),
        });
        let json = null;
        try {
          json = await response.json();
      ...
      validateOwnerUnknownResidentPortalTicketCommentNotFound(unknownResidentPortalTicketComment.status, unknownResidentPortalTicketComment.body);
      const unknownResidentPortalDocumentDownload = await page.evaluate(async () => {
        const response = await fetch("/api/resident-portal/documents/00000000-0000-4000-8000-000000000094/download?leaseId=00000000-0000-4000-8000-000000000000", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownResidentPortalDocumentDownloadNotFound(unknownResidentPortalDocumentDownload.status, unknownResidentPortalDocumentDownload.body);
      const unknownPropertyMaintenancePlanExport = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000095/maintenance-plan/export", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyMaintenancePlanExportNotFound(unknownPropertyMaintenancePlanExport.status, unknownPropertyMaintenancePlanExport.body);
      const unknownPropertyMaintenancePlanGovernance = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000096/maintenance-plan/governance", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyMaintenancePlanGovernanceNotFound(unknownPropertyMaintenancePlanGovernance.status, unknownPropertyMaintenancePlanGovernance.body);
      const unknownPropertyMaintenancePlanAction = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000097/maintenance-plan/action", {
          method: "PATCH",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({
            actionId: "00000000-0000-4000-8000-000000000197",
            title: "E2E unknown maintenance action",
            plannedYear: 2026,
            estimatedCost: 1000,
            priority: "normal",
            risk: "low",
      ...
      validateOwnerUnknownPropertyMaintenancePlanActionNotFound(unknownPropertyMaintenancePlanAction.status, unknownPropertyMaintenancePlanAction.body);
      const unknownPropertyComponentsOverview = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000098/components/overview", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyComponentsOverviewNotFound(unknownPropertyComponentsOverview.status, unknownPropertyComponentsOverview.body);
      const unknownPropertyComponentsManage = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000099/components/manage", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
      ...
      validateOwnerUnknownPropertyComponentsManageNotFound(unknownPropertyComponentsManage.status, unknownPropertyComponentsManage.body);
      const unknownPropertyComponentReport = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000100/components/00000000-0000-4000-8000-000000000200/report", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyComponentReportNotFound(unknownPropertyComponentReport.status, unknownPropertyComponentReport.body);
      const unknownPropertyComponentLinkOptions = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000101/components/00000000-0000-4000-8000-000000000201/link-options", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyComponentLinkOptionsNotFound(unknownPropertyComponentLinkOptions.status, unknownPropertyComponentLinkOptions.body);
      const unknownPropertyComponentMaintenanceSettings = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000102/components/00000000-0000-4000-8000-000000000202/maintenance-settings", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyComponentMaintenanceSettingsNotFound(unknownPropertyComponentMaintenanceSettings.status, unknownPropertyComponentMaintenanceSettings.body);
      const unknownPropertyComponentMaintenanceSettingsPatch = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000103/components/00000000-0000-4000-8000-000000000203/maintenance-settings", {
          method: "PATCH",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
      ...
      validateOwnerUnknownPropertyComponentMaintenanceSettingsPatchNotFound(unknownPropertyComponentMaintenanceSettingsPatch.status, unknownPropertyComponentMaintenanceSettingsPatch.body);
      const unknownPropertyComponentActions = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000104/components/00000000-0000-4000-8000-000000000204/actions", {
          method: "POST",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({
            ...
            title: "E2E unknown component event",
          }),
        });
        let json = null;
        try {
      ...
      validateOwnerUnknownPropertyComponentActionsNotFound(unknownPropertyComponentActions.status, unknownPropertyComponentActions.body);
      const unknownPropertyComponentEntry = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000105/components/00000000-0000-4000-8000-000000000205/entries/event/00000000-0000-4000-8000-000000000305", {
          method: "PATCH",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json", "Content-Type": "application/json" },
          body: JSON.stringify({
            event_type: "service",
            title: "E2E unknown component entry",
            event_date: "2026-09-01",
          }),
        });
        let json = null;
      ...
      validateOwnerUnknownPropertyComponentEntryNotFound(unknownPropertyComponentEntry.status, unknownPropertyComponentEntry.body);
      const unknownPropertyComponentDetail = await page.evaluate(async () => {
        const response = await fetch("/api/properties/00000000-0000-4000-8000-000000000106/components/00000000-0000-4000-8000-000000000206", {
          method: "GET",
          credentials: "same-origin",
          redirect: "manual",
          headers: { Accept: "application/json" },
      ...
      validateOwnerUnknownPropertyComponentDetailNotFound(unknownPropertyComponentDetail.status, unknownPropertyComponentDetail.body);
