    ...
    <div className="space-y-8 animate-fade-in-soft">
      ...
      <Panel title="Användare och roller" description="Här ser du organisationens aktuella rolläge. Roller och användarstatus ändras säkert i Team; ägarrollen är fortsatt särskilt skyddad." bodyClassName="p-0">
        <div className="flex items-center justify-between gap-4 border-b border-sand-100 px-6 py-4">
          ...
          <Link id="hantera-roller" autoFocus href="/dashboard/team#bjud-in" className="scroll-mt-36 shrink-0 rounded-xl border border-sand-200 bg-white px-4 py-2 text-sm font-semibold text-petroleum-800 shadow-premium-sm transition hover:bg-sand-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-petroleum-300">Hantera roller i Team</Link>
        </div>
