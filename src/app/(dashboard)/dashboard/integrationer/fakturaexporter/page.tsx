  ...
  return <div className="mx-auto max-w-7xl space-y-6 animate-fade-in-soft">
    ...
    <Panel title="Filter och sökning" description="Filtrera på leverantör, status, arbetsorder, fastighet eller externt faktura-ID.">
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px_220px]">
        <label className="relative block"><Search className="pointer-events-none absolute left-3 top-3 h-4 w-4 text-ink-400" /><input value={query} onChange={event => setQuery(event.target.value)} placeholder="Sök arbetsorder, fastighet, jobb-ID eller fel..." aria-label="Sök arbetsorder, fastighet, jobb-ID eller fel" className="w-full rounded-xl border border-sand-200 bg-white py-2.5 pl-10 pr-3 text-sm outline-none focus:border-petroleum-500" /></label>
