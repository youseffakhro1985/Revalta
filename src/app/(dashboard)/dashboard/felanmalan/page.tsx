  ...
  return <div className="space-y-4 sm:space-y-5">
    <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
      ...
      <div className="flex flex-wrap gap-2">
        {permissions.canExport ? <a href="/api/tickets/export" className="inline-flex h-10 items-center gap-2 rounded-xl border border-sand-200 bg-white px-4 text-xs font-semibold text-ink-650 transition hover:bg-sand-50"><Download className="h-4 w-4" />Exportera</a> : null}
        {permissions.canManage ? <button type="button" onClick={() => setCreateOpen(true)} className="inline-flex h-10 items-center gap-2 rounded-xl bg-petroleum-900 px-4 text-xs font-semibold text-white shadow-sm transition hover:bg-petroleum-800"><span className="text-base leading-none">＋</span>Nytt ärende</button> : null}
      </div>
    </div>
