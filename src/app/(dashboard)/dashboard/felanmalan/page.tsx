  ...
  return <div className="space-y-4 sm:space-y-5">
    ...
    <section className="grid gap-4 xl:grid-cols-[1.15fr_0.72fr_1fr]">
      <article className="rounded-2xl border border-sand-200 bg-white p-5 shadow-premium-sm">
        <div className="flex items-center justify-between gap-3"><div><h2 className="font-display text-[17px] font-semibold text-ink-950">Ärendeutveckling</h2><p className="mt-1 text-[10px] text-ink-450">Nya och slutförda ärenden över vald period.</p></div><span className="rounded-lg border border-sand-200 bg-surface-subtle px-2.5 py-1.5 text-[9px] font-semibold text-ink-550">{range} dagar</span></div>
        <div className="mt-4 flex gap-4 text-[9px] text-ink-500"><span className="flex items-center gap-1.5"><i className="h-1.5 w-4 rounded-full bg-petroleum-800" />Nya ärenden</span><span className="flex items-center gap-1.5"><i className="h-1.5 w-4 rounded-full bg-success-300" />Slutförda ärenden</span></div>
