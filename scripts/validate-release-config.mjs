...
for (const [fragment, message] of [
  ...
  ["Release attestation must contain exactly", "Strict release runner must reject top-level extensions"],
  ["Release metadata", "Strict release runner must validate release metadata shape"],
  ["transport evidence", "Strict release runner must validate transport shape"],
...
for (const [fragment, message] of [
  ...
  ["Release attestation must contain exactly", "Verifier must reject top-level extensions"],
  ["Release metadata must contain exactly", "Verifier must reject release metadata extensions"],
  ["Release provenance must contain exactly", "Verifier must reject provenance extensions"],
  ["transport evidence", "Verifier must reject transport extensions"],
