...
import { AlertTriangle, CheckCircle2, Clock3, RefreshCw, Send, ServerCog } from "lucide-react";
...
type Data = { draft: { draft_number: string; status: string; sync_status: string }; jobs: SyncJob[] };
...
export function WorkOrderAccountingSyncPanel({ workOrderId }: { workOrderId: string }) {
  ...
  return <Panel title="Ekonomisystem" description="Säker köad synkronisering till Fortnox, Visma eller generisk integration.">
