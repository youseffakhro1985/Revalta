          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex space-x-2">
                ...
                <Link href="/dashboard/drift" className="text-slate-600 hover:text-brand-600 hover:bg-brand-50 px-3 py-2 rounded-lg text-sm font-medium transition-colors">Drift</Link>
