...
export function DocumentsPage({ initialCreate }: { initialCreate: boolean }) {
  ...
  const [showUpload, setShowUpload] = useState(initialCreate);
      ...
      <header className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {data.canManageLifecycle || showUpload ? (
            <button type="button" onClick={() => (showUpload ? closeCreate() : setShowUpload(true))} className={premiumPrimaryButtonClass}>
