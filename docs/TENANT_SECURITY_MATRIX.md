...
| Search / export | Company where clauses | CSV cells quoted; ticket, maintenance-plan, audit and SLA-report exports prefix `=`/`+`/`-`/`@` | Search company scope; ticket export company scope; ticket/maintenance-plan/audit/SLA-report CSV prefixes Tenant B formula titles; maintenance-plan export Tenant B property 404 | Remaining client-side CSV surfaces |
