...
export default function EconomyPage(){
  ...
  useEffect(()=>{
    if(loading) return;
    if(window.location.hash!=="#senasteavier") return;
    document.getElementById("senasteavier")?.scrollIntoView({behavior:"smooth",block:"start"});
    window.setTimeout(() => document.getElementById("senasteavier-alla")?.focus(), 0);
  },[loading,notices]);
