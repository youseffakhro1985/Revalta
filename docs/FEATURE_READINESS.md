...
| Underhåll | PARTIAL | Module exists. Preventive overview and engine run require `canViewOperations` (technicians 403). | Maintenance-plan-to-work-order lifecycle, query and tenant evidence. |
