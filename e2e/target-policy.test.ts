...
const env = { E2E_BASE_URL: "https://revalta-candidate.vercel.app", E2E_EXPECTED_SHA: sha, E2E_PREVIEW_DATA_ISOLATED: "1", E2E_VERIFIED_EMAIL: "fixture@example.com", E2E_VERIFIED_PASSWORD: "fixture-only" };
describe("browser target safety and release evidence", () => {
  ...
  it.each(["E2E_PREVIEW_DATA_ISOLATED", "E2E_VERIFIED_EMAIL", "E2E_VERIFIED_PASSWORD"])("blocks missing %s rather than skipping dashboard tests", (key) => { expect(() => validateTarget({ ...env, [key]: "" })).toThrow(/BLOCKED/); });
