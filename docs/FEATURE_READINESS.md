...
| Underhåll | PARTIAL | Module exists. Preventive overview/engine and portfolio costs require `canViewOperations` (technicians 403). | Maintenance-plan-to-work-order lifecycle, query and tenant evidence. |
