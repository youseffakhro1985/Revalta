...
export function InspectionWorkOrderCenter() {
  ...
  async function load(id: string) {
    if (!id) { setRecord(null); setLinks([]); setLoading(false); return; }
    ...
    try {
      ...
      setRecord(itemsData.record); setLinks(statusData.links || []);
