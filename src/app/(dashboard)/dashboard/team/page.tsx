...
export default function TeamPage() {
  ...
  useEffect(() => {
    if (loading) return;
    if (window.location.hash !== "#teamlista") return;
    document.getElementById("teamlista")?.scrollIntoView({ behavior: "smooth", block: "start" });
  }, [loading, members]);
  ...
  return <div className="space-y-8">
    ...
    <section className="grid gap-6 xl:grid-cols-[390px_1fr]">
      ...
      <div id="teamlista" className="scroll-mt-36">
