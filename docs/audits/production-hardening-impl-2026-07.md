...
6. **Continued hardening (P0/P1)**
   ...
   - Dual-read retirement kill-switch: `REVALTA_MODERN_STORAGE_ONLY=1` / `=0`, with post-cutover default modern-only when `VERCEL_ENV=production` (`mergeByCreatedAt` + WO ops storage skip AuditLog/IE product rows).
