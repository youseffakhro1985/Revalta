...
Verified baseline: `c7c96333f2e01e759522815696de98d0f16392af` (22 Sep 2026, `#940` on `main`). Production `/api/health` at that SHA: `schemaReady: true`, dataplane `e51d9599…`, isolated from Preview `6237f010…`. Staff golden-path, booking-overlap and technician-role Preview E2E are green on that SHA. This branch adds an owner-created resident Preview fixture on the same required job.
